...
resource "aws_security_group" "Atividade4Pos_sg" {
  name        = "Atividade_4_Pos_security_group"
...
resource "aws_instance" "Atividade4Pos" {
  ...
  key_name = "Atividade4Pos"  # Substitua pelo nome do seu par de chaves existente
}